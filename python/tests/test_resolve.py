...
from exception import WrongValidationException, PdaOwnerNotAllowedException, InvalidRoAException
from resolve.resolve import resolve


@pytest.mark.parametrize("domain, result, config", [
    ...
    ("sns-ip-5-wallet-5", "96GKJgm2W3P8Bae78brPrJf4Yi9AN1wtPJwg2XVQ2rMr", {"allow_pda": True, "program_ids": [SYSTEM_PROGRAM_ID]}),
    ("sns-ip-5-wallet-5", "96GKJgm2W3P8Bae78brPrJf4Yi9AN1wtPJwg2XVQ2rMr", {"allow_pda": "any"}),
    ...
    ("sns-ip-5-wallet-10", "96GKJgm2W3P8Bae78brPrJf4Yi9AN1wtPJwg2XVQ2rMr", {"allow_pda": True, "program_ids": [SYSTEM_PROGRAM_ID]}),
    ("sns-ip-5-wallet-10", "96GKJgm2W3P8Bae78brPrJf4Yi9AN1wtPJwg2XVQ2rMr", {"allow_pda": "any"}),
])
@pytest.mark.asyncio
...
@pytest.mark.parametrize("domain, error", [
    ...
    ("sns-ip-5-wallet-12", InvalidRoAException),
])
@pytest.mark.asyncio
...
@pytest.mark.parametrize("domain, owner", [
