...
from tests.fixture import domain_key, subdomain_key, domain_name, subdomain_name, record_subdomain_key, record_subdomain_name
...
def test_get_record_subdomain_key(record_subdomain_name, record_subdomain_key, domain_key):
