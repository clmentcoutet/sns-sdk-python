...
async def get_record(
    connection: AsyncClient, domain: str, record: Record, deserialize: Literal[False]
) -> NameRegistryState | None: ...
...
async def get_record(
    ...
    domain: str,
    record: Record,
    deserialize: Literal[True, False],
...
async def get_record(
    ...
    domain: str,
    record: Record,
    deserialize: Literal[True, False] = False,
) -> str | NameRegistryState | None:
    """
