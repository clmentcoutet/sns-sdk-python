...
exports.getInjectiveRecord = void 0;
 ...
 * @returns
 */
const getInjectiveRecord = (connection, domain) => {
    return (0, getRecord_1.getRecord)(connection, domain, record_1.Record.Injective, true);
};
