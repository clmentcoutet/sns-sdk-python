...
exports.PYTH_PULL_FEEDS = exports.DEFAULT_PYTH_PUSH_PROGRAM = exports.METAPLEX_ID = exports.WOLVES_COLLECTION_METADATA = exports.CUSTOM_BG_TLD = exports.VAULT_OWNER = exports.VAULT_OWNER_DEPRECATED = exports.PYTH_MAPPING_ACC = exports.PYTH_FEEDS = exports.TOKENS_SYM_MINT = exports.REFERRERS = exports.USDC_MINT = exports.TWITTER_ROOT_PARENT_REGISTRY_KEY = exports.TWITTER_VERIFICATION_AUTHORITY = exports.CENTRAL_STATE = exports.REVERSE_LOOKUP_CLASS = exports.REGISTER_PROGRAM_ID = exports.ROOT_DOMAIN_ACCOUNT = exports.HASH_PREFIX = exports.NAME_PROGRAM_ID = void 0;
...
exports.CENTRAL_STATE = exports.REVERSE_LOOKUP_CLASS;
/**
...
exports.REFERRERS = [
    ...
    new web3_js_1.PublicKey("DM1jJCkZZEwY5tmWbgvKRxsDFzXCdbfrYCCH1CtwguEs"), // 4Everland
    new web3_js_1.PublicKey("ADCp4QXFajHrhy4f43pD6GJFtQLkdBY2mjS9DfCk7tNW"), // Bandit network
    new web3_js_1.PublicKey("2XTgjw8yi1E3Etgj4CUyRD7Zk49gynH2U9gA5N2MY4NP"), // Altoscan
    new web3_js_1.PublicKey("5PwNeqQPiygQks9R17jUAodZQNuhvCqqkrxSaeNE8qTR"), // Solscan
    new web3_js_1.PublicKey("8kJqxAbqbPLGLMgB6FhLcnw2SiUEavx2aEGM3WQGhtJF"), // Domain Labs
    new web3_js_1.PublicKey("HemvJzwxvVpWBjPETpaseAH395WAxb2G73MeUfjVkK1u"), // Solflare
    new web3_js_1.PublicKey("7hMiiUtkH4StMPJxyAtvzXTUjecTniQ8czkCPusf5eSW"), // Solnames
    new web3_js_1.PublicKey("DGpjHo4yYA3NgHvhHTp3XfBFrESsx1DnhfTr8D881ZBM"), // Brave
    new web3_js_1.PublicKey("7vWSqSw1eCXZXXUubuHWssXELNQ8MLaDgAs2ErEfCKxn"), // 585.eth
    new web3_js_1.PublicKey("5F6gcdzpw7wUjNEugdsD4aLJdEQ4Wt8d6E85vaQXZQSJ"), // wdotsol
    new web3_js_1.PublicKey("XEy9o73JBN2pEuN7aspe8mVLaWbL4ozjJs1tNRxx8bL"), // GoDID
    new web3_js_1.PublicKey("D5cLoAGjNTHKU1UGv2bYwbnyRoGTMe3sbpLtJW3fRq91"), // SuiNS
    new web3_js_1.PublicKey("FePcCmrr7vgjeFXcXtJHqShSXydaTrga2wfHRt9RrYvP"), // Nansen
];
...
exports.VAULT_OWNER_DEPRECATED = new web3_js_1.PublicKey("GcWEQ9K78FV7LEHteFVciYApERk5YvQuFDQPk1yYJVXi");
exports.VAULT_OWNER = new web3_js_1.PublicKey("5D2zKog251d6KPCyFyLMt3KroWwXXPWSgTPyhV22K2gR");
exports.CUSTOM_BG_TLD = new web3_js_1.PublicKey("BPeXUQDqGbzxeK1LJby6ugvCBuo7kRSEUkjD726mUVsz");
exports.WOLVES_COLLECTION_METADATA = new web3_js_1.PublicKey("72aLKvXeV4aansAQtxKymeXDevT5ed6sCuz9iN62ugPT");
exports.METAPLEX_ID = new web3_js_1.PublicKey("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
exports.DEFAULT_PYTH_PUSH_PROGRAM = new web3_js_1.PublicKey("pythWSnswVUd12oZpeFP8e9CVaEqJg25g1Vtc2biRsT");
exports.PYTH_PULL_FEEDS = new Map([
    [
        "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",
        [
