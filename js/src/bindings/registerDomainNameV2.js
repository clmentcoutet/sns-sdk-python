...
exports.registerDomainNameV2 = void 0;
 ...
 * @returns
 */
const registerDomainNameV2 = (connection_1, name_1, space_1, buyer_1, buyerTokenAccount_1, ...args_1) => __awaiter(void 0, [connection_1, name_1, space_1, buyer_1, buyerTokenAccount_1, ...args_1], void 0, function* (connection, name, space, buyer, buyerTokenAccount, mint = constants_1.USDC_MINT, referrerKey) {
    // Basic validation
    ...
    }).getInstruction(constants_1.REGISTER_PROGRAM_ID, constants_1.NAME_PROGRAM_ID, constants_1.ROOT_DOMAIN_ACCOUNT, nameAccount, reverseLookupAccount, web3_js_1.SystemProgram.programId, constants_1.CENTRAL_STATE, buyer, buyer, buyer, buyerTokenAccount, pythFeedAccount, vault, spl_token_1.TOKEN_PROGRAM_ID, web3_js_1.SYSVAR_RENT_PUBKEY, derived_state, refTokenAccount);
    ixs.push(ix);
    return ixs;
});
exports.registerDomainNameV2 = registerDomainNameV2;
