...
import {getAllDomains, getDomainKeysWithReverses, getDomainKeySync, RecordVersion} from "./src";
...
const runTest = async () => {
  ...
  try {
    ...
    const res = await getDomainKeysWithReverses(connection, nameAccount);
